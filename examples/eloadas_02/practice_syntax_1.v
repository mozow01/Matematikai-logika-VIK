(* Gyakorlás 13/16: azonos ágak, eltérő szintaxis. *)
...
(* Útmutatás: az első rész konstruktorok különbözőségéről, a második a
   jelentésről szól. Az Abort. helyére írd a taktikákat, majd használj
   Qed.-et. *)
