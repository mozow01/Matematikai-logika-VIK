(* Gyakorlás 9/16: a kettős negáció denotációja. *)
...
(* Útmutatás: ez denotációs, nem szintaktikai azonosság; bonts esetekre a
   denote A értéke szerint. Az Abort. helyére írd a taktikákat, majd zárd
   Qed.-del. *)
